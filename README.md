[![](https://godoc.org/github.com/iguanito/pgx?status.svg)](https://godoc.org/github.com/iguanito/pgx)
[![Build Status](https://travis-ci.org/iguanito/pgx.svg)](https://travis-ci.org/iguanito/pgx)
...
See this [gist](https://gist.github.com/iguanito/4996e8648a0c59839bff644f49d6e434) for the underlying benchmark results or checkout [go_db_bench](https://github.com/iguanito/go_db_bench) to run tests for yourself.

In addition to the native driver, pgx also includes a number of packages that provide additional functionality.

## github.com/iguanito/pgx/stdlib
...
## github.com/iguanito/pgx/pgmock

pgmock offers the ability to create a server that mocks the PostgreSQL wire protocol. This is used internally to test pgx by purposely inducing unusual errors. pgproto3 and pgmock together provide most of the foundational tooling required to implement a PostgreSQL proxy or MitM (such as for a custom connection pooler).

## Documentation

pgx includes extensive documentation in the godoc format. It is viewable online at [godoc.org](https://godoc.org/github.com/iguanito/pgx).
