...
github.com/iguanito/pgx/stdlib to use pgx as a database/sql compatible driver.
...
pgx uses the github.com/iguanito/pgx/pgtype library to support more types. See
...
(https://github.com/iguanito/pgx/pull/476). If you need TLS Renegotiation,
